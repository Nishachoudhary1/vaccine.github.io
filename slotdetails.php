...
$sql = "SELECT slotbookinginformation.* , user_information.* FROM slotbookinginformation , user_information WHERE slotbookinginformation.u_name ='".$uname."' AND slotbookinginformation.u_name = user_information.uname";
...
while($userid = mysqli_fetch_array($uid)) {	
 ...
 $centre=$userid["center"];
 $book_date=$userid["book_date"];
 $book_time=$userid["book_time"];
