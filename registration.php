...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql1 = "SELECT user_credentials.* , user_information.aadhar FROM user_credentials, user_information WHERE aadhar ='".$aadhar."' AND user_credentials.UserName = user_information.uname";
...
elseif(!empty($user_id) && empty($user_id1)){
 ...
 header("Location: ".$baseurl."setcredentials.php");
  ...
  $sql2 = "INSERT INTO user_credentials (UserName) VALUES ('".$username."')";
  if ($conn->query($sql2) === TRUE){


    $sql3 = "INSERT INTO user_information (uname, fname, lname, dob, aadhar, mobile,  email, address) VALUES ('".$username."', '".$fname."' , '".$lname."','".$dob."', '".$aadhar."', '".$mobile."', '".$email."', '".$address."')";
...
<body>
  <div class="body">
    ...
    <footer class="footer">© 2021 All Rights Reserved. Developed & Design by Nisha Choudhary</footer>
  </div>
</body>
</html>