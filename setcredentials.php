...
$sql1 = "SELECT  uname FROM user_information WHERE uname ='".$username."'";
$uid = mysqli_query($conn, $sql1);
while($userid = mysqli_fetch_array($uid)) { 

$user_id = $userid["uname"];
...
$sql2 = "UPDATE user_credentials SET UserName='".$username."', Password='".$password."' WHERE UserName='".$_SESSION['username']."'";
 
 if ($conn->query($sql2) === TRUE){



$sql3 = "UPDATE user_information SET uname='".$username."' WHERE uname='".$_SESSION['username']."'"; 
...
<body>
  ...
  <footer class="footer">© 2021 All Rights Reserved. Developed & Design by Nisha ChoudharyS</footer>
  </div>
</body>
</html>